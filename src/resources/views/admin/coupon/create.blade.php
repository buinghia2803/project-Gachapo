...
@section('title', __('labels.ACPL001_L001'))
@section('content')
    <div class="content-wrapper">
        <div class="container-fluid pt-3">
                <ul class="breadcrumb">
                    <li><a href="/admin/coupon" title="">{{ __('labels.ACPL001_L003') }}</a></li>
                    <li><span>{{ __('labels.ACPL001_L001') }}</span></li>
                </ul>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('labels.ACPL001_L001') }}</h3>
                            </div>
                            <!-- form start -->
                            <form action="{{ route('admin.coupon.store') }}" id="create_coupon_form" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="row d-flex align-items-baseline">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <input type="text" name="name" class="form-control"
                                                        id="name" placeholder="{{ __('labels.ACPL001_L004') }}" value="{{ old('name') }}">
                                                    @error('name')
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between type_discount_wrap">
                                                        <div class="rating d-flex justify-content-between align-items-center w-150px">
                                                            <input class="form-check-input"
                                                                ...
                                                                id="rate"
                                                                checked
                                                                {{ COUPON_TYPE_PERCENT == old('type_discount') ? 'checked':'' }}>
                                                            <input type="text"
                                                                id="discount_rate"
                                                        ...
                                                        <div class="amouting d-flex justify-content-between align-items-center w-200px ml-5">
                                                            <input class="form-check-input"
                                                                ...
                                                                name="type_discount"
                                                                id="amount"
                                                                {{ COUPON_TYPE_PRICE == old('type_discount') ? 'checked':'' }}>
                                                            <input type="text"
                                                                id="discount_amount"
                                            ...
                                            <div class="row d-flex align-items-baseline">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="d-flex align-items-center">
                                                        <input class="form-control" name="period_start" autocomplete="off" id="period_start" value="{{ old('period_start') }}" />
                                                        <span class="ml-2 mr-2 fz-16px">~</span>
                                                        <input class="form-control" name="period_end" autocomplete="off" id="period_end" value="{{ old('period_end') }}" />
                                                    </div>
                                        ...
                                        <div class="form-group col-12 col-xl-9">
                                            <div class="row d-flex align-items-baseline">
                                                ...
                                                <div class="col-12 col-md-8 d-flex justify-content-center d-md-inline-block">
                                                    <button type="submit"
                                                            class="btn btn-primary">{{ __('labels.CM001_L010') }}</button>
...
@section('javascript')
    <script type="text/javascript">
        ...
        const errorEndTime = '{{ __('messages.ANM001_MSG001') }}';
    </script>
    <script type="text/javascript">
        $(document).ready(function () {
            if (sessionStorage.getItem("couponCode")) {
                $('input[name=code]').val(sessionStorage.getItem("couponCode"));
