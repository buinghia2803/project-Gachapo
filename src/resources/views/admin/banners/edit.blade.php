...
@section('title', __('labels.BNN001_L011').' - '.__('labels.CM001_L009'))
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{__('labels.BNN001_L011').' - '.__('labels.CM001_L009')}}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.banners.update-confirm', $data->id) }}" id="edit_banner_main_visuals_form" method="POST" enctype="multipart/form-data">
                            @csrf
