...
<div class="content-wrapper">
    <div class="container-fluid pt-3">
        <ul class="breadcrumb">
            ...
            <li><a href="{{ route('admin.banners.create') }}" title="">{{__('labels.CM001_L006')}}</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.banners.store') }}" id="create_banner_main_visuals_form" method="POST" enctype="multipart/form-data">
                            @csrf
