    ...
    <div class="content-wrapper">
        <div class="container-fluid pt-3">
            <ul class="breadcrumb">
                ...
                <li><a href="/admin/notify/{{$data['notify_id']}}/edit" title="">{{ __('labels.CM001_L009') }}</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- form start -->
                    <form action="{{ route('admin.notify.update', $data['notify_id']) }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        @method("PUT")
                        <input type="hidden" name="check_new_upload">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-10 col-md-8 d-flex justify-content-center d-md-inline-block">
                                    <button type="submit"
                                            ...
                                            id="save_notify">{{ __('labels.CM001_L014') }}</button>
