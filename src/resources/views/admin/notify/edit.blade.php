...
@section('title', __('labels.NMC001_L007'))
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('labels.NMC001_L007') }}</h3>
                    </div>
                    <!-- form start -->
                    <form action="{{ route('admin.notify.update-verify') }}" enctype="multipart/form-data" id="update_notify_form" method="POST">
                        @csrf
                            ...
                            <div class="row form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control"
                                            ...
                                            value="{{ old('start_time', $notify->start_time) }}" />
                                        @error('start_time')
                                        <div class="error-valid">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control datepicker"
                                            ...
                                            value="{{ old('end_time', $notify->end_time) }}" />
                                        @error('end_time')
                                        <div class="error-valid">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-10 col-md-8">
                                    <div class="switch-container">
                                        <input type="checkbox" name="status" {{ (old('status', $notify->status) == 1 || old('status') ) ? "checked" : "" }} id="noti_type"/>
                                        <label for="noti_type"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                                <label class="col-lg-2 col-md-4">{{ __('labels.NML001_L005') }}<span
                                        class="required">*</span></label>
                                <div class="col-lg-10 col-md-8">
                                    @foreach ($listType as $key => $item)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input form-control"
                                                ...
                                                name="type"
                                                id="type-{{ $key }}"
                                                {{ $key === old('type', $notify->type) ? 'checked':'' }}>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-10 col-md-8 d-flex justify-content-center d-md-inline-block">
                                    <button type="submit"
                                            ...
                                            id="update_notify">{{ __('labels.CM001_L002') }}</button>
