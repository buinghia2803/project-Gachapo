...
@section('title', __('labels.AC001_C001'))
@section('content')
    <div class="content-wrapper">
        <div class="container-fluid pt-3">
                <ul class="breadcrumb">
                    <li><a href="/admin/category" title="">{{__('labels.AC001_L001')}}</a></li>
                    <li><span>{{__('labels.CM001_L029')}}</span></li>
                </ul>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{__('labels.AC001_C001')}}</h3>
                            </div>
                            <!-- form start -->
                            <form action="{{ route('admin.category.store') }}" id="create_category_form" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="row d-flex align-items-baseline">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <input type="text" name="name" class="form-control"
                                                        id="name" placeholder="{{__('labels.AC001_CN001')}}" value="{{ old('name') }}">
                                                    @error('name')
                                            ...
                                            <div class="row d-flex align-items-baseline">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <input type="text" name="slug" class="form-control"
                                                        id="slug" placeholder="{{__('labels.AC001_CS001')}}" required value="{{ old('slug') }}">
                                                    @error('slug')
                                                    <div class="error-valid">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group col-12 col-xl-9">
                                            <div class="row d-flex align-items-baseline">
                                                ...
                                                <div class="col-12 col-md-8 d-flex justify-content-center d-md-inline-block">
                                                    <button type="submit"
                                                            class="btn btn-primary">{{__('labels.ACC01_SB001')}}</button>
...
@section('javascript')
    ...
    <script src="{{ url(mix('js/admin/category/create_category_validation.js')) }}"></script>
@endsection
