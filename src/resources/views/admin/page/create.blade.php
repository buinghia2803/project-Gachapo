...
@section('title', __('labels.APM001_L002'))
@section('content')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('labels.APM001_L002') }}</h3>
                            </div>
                            <!-- form start -->
                            <form action="{{ route('admin.pages.store') }}" id="create_page_form" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="row d-flex align-items-baseline">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <input type="text" name="title" class="form-control"
                                                        id="title" placeholder="{{__('labels.AC001_CN001')}}" value="{{ old('title') }}">
                                                    @error('title')
                                            ...
                                            <div class="row d-flex align-items-baseline">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <input type="text" name="slug" class="form-control"
                                                        id="slug" placeholder="{{__('labels.AC001_CS001')}}" value="{{ old('slug') }}">
                                                    @error('slug')
                                                    <div class="error-valid">
                                                        {{ $message }}
                                                    </div>
