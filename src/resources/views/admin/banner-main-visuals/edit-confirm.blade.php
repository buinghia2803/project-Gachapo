...
<div class="content-wrapper">
    <div class="container-fluid pt-3">
        <ul class="breadcrumb">
            ...
            <li><a href="{{ route('admin.banner-main-visuals.edit', $data->id) }}" title="">{{__('labels.CM001_L009')}}</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.banner-main-visuals.update', $data->id) }}" id="create_banner_main_visuals_form" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
