    ...
    <div class="row m-0 p-3">
        ...
        <div class="col-12 col-md-8 content-wrapper m-0 p-0">
            <div class="main-header text-center mt-3 mt-md-5 mb-3">
                <a href="{{ route('company.password.email') }}" class="brand-link title-page">
                    <h3>Online Gacha</h3>
                </a>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('company.password.email') }}" id="forgot_password_form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-2">
                                            <button type="button" id="icon_loading" class="btn btn-primary col-12 mb-3">{{__('labels.CM001_L034')}}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $('#icon_loading').on('click', function () {
