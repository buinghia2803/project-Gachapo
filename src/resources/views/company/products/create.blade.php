...
@section('title', __('labels.GAC001_L040', [ 'attr' => '○○賞' ]))
@section('content')
<div class="content-wrapper">
    <div class="container-fluid pt-3">
        <ul class="breadcrumb">
            ...
            <li><a href="" title="">{{__('labels.GAC001_L040', [ 'attr' => '１等' ])}}</a></li>
        </ul>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{__('labels.GAC001_L040', [ 'attr' => '○○賞' ])}}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('company.products.store') }}" id="product_form" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            @include('company.components.form.radio', [
                                'name' => 'reward_status',
                                'value' => old('reward_status', PRODUCT_REWARD_INVENTORY),
