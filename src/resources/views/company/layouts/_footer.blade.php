<div class="__footer">
    <div>
        <div class="main-footer pt-5 pb-3 pb-md-4">
            <div class="p-35 container">
                <div class="footer-title">
                    Online Gacha
                </div>
                <div class="row d-flex flex-column flex-md-row pt-1">
                    @if(Session::has('static_page') && count(Session::get('static_page')))
                        @foreach(Session::get('static_page') as $part)
                        ...
                        @endforeach
                    @endif
                    <div class="th-footer mt-4 mt-md-0 col">
                        <div class="info-list d-flex">
                            <div class="mr-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                    <path id="facebook-square-brands"
                            ...
                            <div class="mr-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                    <path id="instagram-square-brands"
