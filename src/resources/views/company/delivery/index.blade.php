...
@section('content')
    <div class="content-wrapper">
        <div class="container-fluid pt-3">
            <ul class="breadcrumb">
                <li><a href="{{ route('company.delivery.index') }}" title="">{{ __('labels.ADEL001_L001') }}</a></li>
            </ul>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title" style="margin-right: 10px">{{ __('labels.ADEL001_L001') }}</h3>
                        </div>
                        <!-- body start -->
                        <div class="card-body">
                            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <!-- filter start -->
                                <form action="{{ route('company.delivery.index') }}" method="GET">
                                    <div class="row mb-4 form-search">
                                        ...
                                        <div class="col-sm-6 col-xl-6">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <input class="form-control" name="start_date" autocomplete="off"
                                                    id="start_date" value="{{ Request::get('start_date') }}" />
                                                <span class="ml-2 mr-2 fz-16px">~</span>
                                                <input class="form-control" name="end_date" autocomplete="off"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 d-flex">
                                            <button type="submit"
                                                class="btn btn-primary float-right">{{ __('labels.ADEL001_L006') }}</button>
                                        </div>
                                    </div>
                                </form>
                                <!-- filter end -->
                                                ...
                                                <thead>
                                                    <tr>
                                                        <form action="" method="get" id="form-sort">
                                                            <th class="tb-no w-65px mw-65px">
                                                                {{ __('labels.ADEL001_L002') }}<i
                                                                    class="fas fa-sort mt-1 float-right sort-data"
                                                                    desc="{{ Request::get('sort_type') }}"
                                                                    content-value="id"></i></th>
                                                            <th class="w-160px mw-160px">{{ __('labels.CM001_L038') }}
                                                            </th>
                                                            <th class="w-160px mw-160px">{{ __('labels.GAC001_L016') }}
                                                            </th>
                                                            ...
                                                            <th class="w-150px mw-150px">{{ __('labels.CM001_L011') }}
                                                            </th>
                                                        ...
                                                        @foreach ($deliveries as $index => $delivery)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <div>
                                                                        <a href="{{ route('company.delivery.show', $delivery->id) }}"
                                                                            class="btn btn-primary"
                                                                            style="margin-right: 0 !important;">
                                                                            {{ __('labels.CM001_L011') }}
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-12 col-md-5 d-flex justify-content-end">
                                        <form action="{{ route('company.delivery.export-file') }}" method="POST">
                                            @csrf
                                            ...
                                            <button type="submit"
                                                class="btn btn-default float-right">{{ __('labels.ANLT001_L006') }}</button>
                                        </form>
                                    </div>
