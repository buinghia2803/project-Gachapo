...
loadingDirective.install = Vue => {
  ...
  /**
   * Show/hide loading when loading is changed
   *
   * @param {object} el - Element object
   * @param {object} binding - Binding object of directive
   */
    ...
    if (binding.value) {
      Vue.nextTick(() => {
        if (binding.modifiers.fullscreen) {
          ...
          // Disable scroll when loading fullscreen
          disableScroll()
      ...
      afterLeave(
        ...
        _ => {
          ...
          // Enable scroll after finish loading
          enableScroll()
